...
exports.deletePhaseHandler =
    exports.getPhasesHandler =
    exports.getPhaseHandler =
    exports.updatePhaseHandler =
    exports.createPhaseHandler =
        void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        (0, phase_service_1.createPhase)(__assign({}, body)),
                    ];
                case 1:
                    Phase = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        (0, phase_service_1.findPhase)({ phaseId: phaseId }),
                    ];
                case 1:
                    phase = _a.sent();
                    if (!phase) {
                    ...
                    return [
                        4 /*yield*/,
                        (0, phase_service_1.findAndUpdatePhase)(
                            { phaseId: phaseId },
                            update,
                            {
                                new: true,
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [
                        4 /*yield*/,
                        (0, phase_service_1.findPhase)({ _id: phaseId }),
                    ];
                case 1:
                    phase = _a.sent();
                    if (!phase) {
...
function getPhasesHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, (0, phase_service_1.getAllPhases)()];
                case 1:
                    Phases = _a.sent();
                    if (!Phases) {
                        return [2 /*return*/, res.sendStatus(404)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/,
                        (0, phase_service_1.deletePhase)({ phase: phase }),
                    ];
                case 2:
                    _a.sent();
