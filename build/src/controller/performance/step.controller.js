...
exports.deleteStepHandler = exports.getStepsHandler = exports.getStepHandler = exports.updateStepHandler = exports.createStepHandler = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    body = req.body;
                    return [4 /*yield*/, (0, step_service_1.createStep)(__assign({}, body))];
                case 1:
                    Step = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    update = req.body;
                    return [4 /*yield*/, (0, step_service_1.findStep)({ stepId: stepId })];
                case 1:
                    step = _a.sent();
                    if (!step) {
                        return [2 /*return*/, res.sendStatus(404)];
                    }
                    return [4 /*yield*/, (0, step_service_1.findAndUpdateStep)({ stepId: stepId }, update, {
                            new: true,
                        })];
                case 2:
                    updatedStep = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    stepId = req.params.stepId;
                    return [4 /*yield*/, (0, step_service_1.findStep)({ _id: stepId })];
                case 1:
                    step = _a.sent();
                    if (!step) {
                        return [2 /*return*/, res.sendStatus(404)];
...
function getStepsHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, step_service_1.getAllSteps)()];
                case 1:
                    steps = _a.sent();
                    if (!steps) {
                        return [2 /*return*/, res.sendStatus(404)];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, step_service_1.deleteStep)({ step: step })];
                case 2:
                    _a.sent();
