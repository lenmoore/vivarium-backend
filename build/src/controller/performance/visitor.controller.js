...
exports.deleteVisitorHandler = exports.getVisitorsHandler = exports.getPerformanceVisitorsHandler = exports.getVisitorHandler = exports.updateVisitorHandler = exports.archiveVisitors = exports.archiveVisitorsHandler = exports.updateVisitorColorsHandler = exports.createVisitorHandler = void 0;
...
var quiz_results_model_1 = __importDefault(require("../../models/performance/quiz-results.model"));
var visitor_model_1 = __importDefault(require("../../models/performance/visitor.model"));
function createVisitorHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var user, accessToken, userId, body, visitor, visitorBasket, performance_1, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    user = _a.sent();
                    return [4 /*yield*/, (0, auth_service_1.signVisitorAccessToken)(user)];
                case 2:
                    accessToken = _a.sent();
                    if (accessToken) {
                    ...
                    userId = user.id;
                    body = req.body;
                    return [4 /*yield*/, (0, visitor_service_1.createVisitor)(__assign(__assign({}, body), { user: userId }))];
                case 3:
                    visitor = _a.sent();
                    return [4 /*yield*/, (0, basket_service_1.createBasket)({
                            user: user,
                            visitor: visitor,
                            coins_left: 100,
                            products: [],
                ...
                case 4:
                    ...
                    return [4 /*yield*/, (0, performance_service_1.findPerformance)({
                            performanceId: body.performance,
                        })];
                case 5:
                    performance_1 = _a.sent();
                    return [4 /*yield*/, (0, visitor_service_1.findAndUpdateVisitor)({ _id: visitor._id }, {
                ...
                case 6:
                    visitor = _a.sent();
                    return [4 /*yield*/, (0, performance_service_1.findAndUpdatePerformance)({ performanceId: body.performance }, { visitors: __spreadArray(__spreadArray([], performance_1.visitors, true), [visitor._id], false) }, {
                            new: true,
                        })];
                case 7:
                    _a.sent();
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, (0, visitor_service_1.confirmVisitorColors)(req.body)];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, visitor_model_1.default.updateMany({ performance: update._id }, { archived: true })];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
function updateVisitorHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        var visitorId, update, visitor, addQuizResults, quizResults, _i, quizResults_1, qr, result, result, updatedVisitor, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                    ...
                    update = req.body;
                    return [4 /*yield*/, (0, visitor_service_1.findVisitor)({ visitorId: visitorId })];
                case 1:
                    visitor = _a.sent();
                    if (!visitor) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, quiz_results_model_1.default.create(__assign(__assign({}, qr), { visitor: visitor, result_humanity_values: {
                                green: 0,
                                red: 0,
                                blue: 0,
                                orange: 0,
                ...
                case 3:
                    ...
                    return [3 /*break*/, 6];
                case 4: return [4 /*yield*/, quiz_results_model_1.default.findByIdAndUpdate({ _id: qr._id }, qr)];
                case 5:
                    result = _a.sent();
                    addQuizResults.push(result);
                ...
                case 6:
                    _i++;
                    return [3 /*break*/, 2];
                case 7: return [4 /*yield*/, (0, visitor_service_1.findAndUpdateVisitor)({ visitorId: visitorId }, __assign(__assign({}, update), { quiz_results: addQuizResults }), {
                        new: true,
                    })];
                case 8:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, visitor_service_1.getAllVisitors)({
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, visitor_service_1.deleteVisitor)({ visitorId: visitorId })];
                case 2:
                    _a.sent();
