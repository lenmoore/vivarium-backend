...
exports.deletePerformanceHandler = exports.getPerformancesHandler = exports.getPerformanceHandler = exports.updatePerformanceHandler = exports.createPerformanceHandler = void 0;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    body = req.body;
                    return [4 /*yield*/, (0, performance_service_1.createPerformance)(__assign(__assign({}, body), { user: userId }))];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, (0, performance_service_1.findAndUpdatePerformance)({ _id: performanceId }, update, {
                            new: true,
                        })];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    performanceId = req.params.performanceId;
                    return [4 /*yield*/, (0, performance_service_1.findPerformance)({ performanceId: performanceId })];
                case 1:
                    performance = _a.sent();
                    if (!performance) {
...
function getPerformancesHandler(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, performance_service_1.getAllPerformances)()];
                case 1:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, performance_service_1.deletePerformance)({ performanceId: performanceId })];
                case 2:
                    _a.sent();
