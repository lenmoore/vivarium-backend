...
function reIssueAccessToken(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, jwt_utils_1.verifyJwt)(refreshToken, 'refreshTokenPublicKeyEncoded')];
                case 1:
                    decoded = _b.sent();
                ...
                case 3:
                    ...
                    if (!user)
                        return [2 /*return*/, false];
                    return [4 /*yield*/, (0, jwt_utils_1.signJwt)(__assign(__assign({}, user), { session: session._id }), 'accessTokenPrivateKeyEncoded')];
                case 4:
                    accessToken = _b.sent();
