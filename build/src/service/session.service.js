        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [
                        4 /*yield*/,
                        session_model_1.default.create({
                            user: userId,
                            userAgent: userAgent,
                        }),
                    ];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [
                        4 /*yield*/,
                        session_model_1.default.findById(
                            (0, lodash_1.get)(decoded, 'session')
                        ),
                    ];
                case 2:
                    session = _b.sent();
                    ...
                    return [
                        4 /*yield*/,
                        (0, user_service_1.findUser)({ _id: session.user }),
                    ];
                case 3:
                    user = _b.sent();
